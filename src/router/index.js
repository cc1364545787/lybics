...
const ChangeRole = resolve => require(['@/components/ChangeRole'], resolve);
...
const upNew = resolve => require(['@/components/business/upNew'], resolve);
const down = resolve => require(['@/components/business/down'], resolve);
const myAds = resolve => require(['@/components/business/myAds'], resolve);
const myOdr = resolve => require(['@/components/business/myOdr'], resolve);

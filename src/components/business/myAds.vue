  ...
  <div>
    <div class="address-box" v-for="(item, index) in address" :key="index">
      ...
      <div class="address-content">
        <p><span class="address-content-title"> 发 货 人 :</span> {{item.name}}</p>
        <p><span class="address-content-title">发货地区:</span> {{item.province}} {{item.city}} {{item.area}}</p>
        <p><span class="address-content-title">发货地址:</span> {{item.address}}</p>

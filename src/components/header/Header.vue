<template>
  <div class="box">
    <div class="nav">
      ...
      <ul class="detail">
        <li><router-link to="/business">商品信息管理</router-link></li>
        <li v-if="path='/business'"><router-link to="/">商城首页</router-link></li>
        <li>
          <Dropdown  placement="bottom-start">
            <a href="javascript:void(0)">
        ...
        <li><router-link to="/home">个人信息中心</router-link></li>
        ...
        <li v-show="!!userInfo.username">
          <Dropdown>
            ...
            <DropdownMenu slot="list">
                <div class="my-page">
                  <div class="my-info" @click="changeRole">
                    <Icon type="home"></Icon>
                    <p>身份切换</p>
                  </div>
